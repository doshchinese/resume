    ...
    render() {
        ...
        return (
            <div className="sidebar">
                ...
                <h1><HashLink smooth to="/#start" className="h1_links"> STUART K. CHEROTWO</HashLink></h1>
                <p style={{color:'black',fontWeight:'bold'}} className="gmail"> kaitotilietab@gmail.com</p>
                ...
                <div className="flip-card-back">
                    <ul className="sidebar-nav">
                        <li className="sidebar-nav-icons"> 
                            <a 
                                href="https://github.com/doshchinese" 
                        ...
                        <li className="sidebar-nav-icons"> 
                            <a 
                                href="mailto:kaitotilietab@gmail.com" 
                                rel="opener noreferrer" 
                                target="_blank" 
