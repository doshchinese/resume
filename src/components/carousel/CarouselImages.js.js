            ...
            >
                <div  className={classes.image_container} >
                    ...
                    <div  className={classes.h1}>
                        <h1 >I'm STUART</h1>
                        <a 
                            href="https://drive.google.com/file/d/13wrwM76m5n481S1PO9hysihJy2cKoV2V/view?usp=sharing" 
                ...
                <div className={classes.image_container}>
                    ...
                    <h1>THINGS!!</h1>
                    <a href="https://github.com/doshchinese" rel="opener noreferrer" target="_blank">VIEW PROJECTS   <GoProject/></a>
                    </div>
                </div>
                <div className={classes.image_container}>
